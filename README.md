...
- **Rating Pro 2.0 / 3.0** — 按 T/CT 侧分别估算击杀、生存、修正 KAST、伤害与影响；RP3 再加入逐回合经济、多杀、补枪/闪光助攻和 Round Swing，并按 HLTV 2025-10 公开方向提高击杀、降低 Swing 权重。界面可展开六项分数、置信度、纯保枪和经济修正，并标出胜方英雄与负方战犯；评分明确不是 HLTV 官方值，算法边界见 [方法说明](./docs/rating-pro-methodology.md)。
