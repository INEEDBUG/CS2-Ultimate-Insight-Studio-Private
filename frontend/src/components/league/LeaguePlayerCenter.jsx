...
export default function LeaguePlayerCenter({ currentPuuid = "", onError }) {
  ...
  return <div className="space-y-4">
    ...
    {data&&<div className="flex justify-end"><span className="rounded-md border border-cyan-400/20 bg-cyan-400/10 px-2 py-1 text-[10px] font-semibold text-cyan-200">当前战绩源：{String(data.match_source||"lcu").toUpperCase()}</span></div>}
  </div>;
}
